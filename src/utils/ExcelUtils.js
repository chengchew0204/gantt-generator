...
const SETTINGS_FIELDS = [
  ...
  { key: 'themeName', label: 'Theme Name', defaultValue: 'Linear Dark' },
  { key: 'themeBgPrimary', label: 'Theme BG Primary', defaultValue: '#0f0f12' },
  { key: 'themeBgSecondary', label: 'Theme BG Secondary', defaultValue: '#1a1a23' },
  { key: 'themeBgTertiary', label: 'Theme BG Tertiary', defaultValue: '#23232f' },
  { key: 'themeBgHover', label: 'Theme BG Hover', defaultValue: '#2a2a38' },
  { key: 'themeBorder', label: 'Theme Border', defaultValue: '#2e2e3a' },
  { key: 'themeBorderSubtle', label: 'Theme Border Subtle', defaultValue: '#232330' },
  { key: 'themeTextPrimary', label: 'Theme Text Primary', defaultValue: '#e8e8ed' },
  { key: 'themeTextSecondary', label: 'Theme Text Secondary', defaultValue: '#9898a8' },
  { key: 'themeTextMuted', label: 'Theme Text Muted', defaultValue: '#66667a' },
  { key: 'themeAccent', label: 'Theme Accent', defaultValue: '#6366f1' },
  { key: 'themeAccentHover', label: 'Theme Accent Hover', defaultValue: '#818cf8' },
  { key: 'themeSuccess', label: 'Theme Success', defaultValue: '#22c55e' },
  { key: 'themeWarning', label: 'Theme Warning', defaultValue: '#f59e0b' },
  { key: 'themeDanger', label: 'Theme Danger', defaultValue: '#ef4444' },
  { key: 'themeInfo', label: 'Theme Info', defaultValue: '#3b82f6' },
  { key: 'themeCriticalPath', label: 'Theme Critical Path', defaultValue: '#f43f5e' },
  { key: 'showCriticalPath', label: 'Show Critical Path', defaultValue: 'true' },
  { key: 'showSlack', label: 'Show Slack', defaultValue: 'true' },
  { key: 'showDependencies', label: 'Show Dependencies', defaultValue: 'true' },
  ...
  { key: 'visibleColumns', label: 'Visible Columns', defaultValue: 'id,name,duration,startDate,endDate,progress,status' },
